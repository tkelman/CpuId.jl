...
const __cpufeaturemap = Dict{Symbol, Tuple{UInt32, Symbol, UInt32, String}}(
    ...
    :VME           => (0x0000_0001, :EDX , 1  , "Virtual 8086 mode extensions"),
    :DE            => (0x0000_0001, :EDX , 2  , "Debugging extensions"),
    :PSE           => (0x0000_0001, :EDX , 3  , "Page size extension"),
    :TSC           => (0x0000_0001, :EDX , 4  , "Time stamp counter"),
    :MSR           => (0x0000_0001, :EDX , 5  , "Model-specific registers"),
    :PAE           => (0x0000_0001, :EDX , 6  , "Physical address extension"),
    :MCE           => (0x0000_0001, :EDX , 7  , "Machine check exception"),
    :CX8           => (0x0000_0001, :EDX , 8  , "CMPXCHG8 instruction (compare and swap)"),
    :APIC          => (0x0000_0001, :EDX , 9  , "Onboard advanced programmable interrupt controller"),
    ...
    :PGE           => (0x0000_0001, :EDX , 13 , "Page global enable bit in CR4"),
    :MCA           => (0x0000_0001, :EDX , 14 , "Machine check architecture"),
    :CMOV          => (0x0000_0001, :EDX , 15 , "Conditional move and FCMOV instructions"),
    ...
    :ACPI          => (0x0000_0001, :EDX , 22 , "Onboard thermal control MSRs for ACPI"),
    :MMX           => (0x0000_0001, :EDX , 23 , "64bit Multimedia Streaming Extensions"),
    :FXSR          => (0x0000_0001, :EDX , 24 , "FXSAVE, FXRESTOR instructions, CF4 bit 9"),
    :SSE           => (0x0000_0001, :EDX , 25 , "128bit Streaming SIMD Extensions 1"),
    :SSE2          => (0x0000_0001, :EDX , 26 , "128bit Streaming SIMD Extensions 2"),
    :SS            => (0x0000_0001, :EDX , 27 , "CPU cache supports self-snoop"),
    :HTT           => (0x0000_0001, :EDX , 28 , "Hyper-threading"),
    :TM1           => (0x0000_0001, :EDX , 29 , "Thermal monitor automatically limits temperature"),
    ...
    :ITSC          => (0x8000_0007, :EDX , 8  , "Invariant TSC"),
